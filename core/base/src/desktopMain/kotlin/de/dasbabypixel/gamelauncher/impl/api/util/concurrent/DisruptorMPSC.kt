...
import de.dasbabypixel.gamelauncher.util.concurrent.Handler
import de.dasbabypixel.gamelauncher.util.concurrent.MPSC
import de.dasbabypixel.gamelauncher.util.concurrent.Poller
import de.dasbabypixel.gamelauncher.util.concurrent.PublisherThreeArgs
import de.dasbabypixel.gamelauncher.util.concurrent.ThreeArgs
        ...
        return object : MPSC<T> {
            ...
            override fun createPoller(handler: Handler<T>): Poller {
                ...
                val h = EventPoller.Handler<T> { event, _, endOfBatch ->
                    handler.handle(event, endOfBatch)
                }
