        ...
        fun create(
            ...
            return MemoryStack.stackPush().use { stack ->
                ...
                val scissor = VkRect2D.calloc(1, stack)
                    ...
                    .extent(VkExtent2D.calloc(stack).set(swapChainExtent.x, swapChainExtent.y))
                ...
                val pipelineRenderingCreateInfo = VkPipelineRenderingCreateInfo.calloc(stack)
                    ...
                    .pColorAttachmentFormats(stack.ints(surfaceFormat.format))

                val pipelineLayout = VKPipelineLayout.create(tracker, device.device)
