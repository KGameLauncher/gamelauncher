...
import de.dasbabypixel.gamelauncher.api.util.concurrent.ThreadGroupCache.get

actual class NativeThread {

}

internal actual val provider: ThreadsProvider = object : ThreadsProvider {
...
object CommonThreadHelper : ThreadsProvider {
    ...
    init {
        @Suppress("UnusedExpression") ThreadGroupCache // init group cache
