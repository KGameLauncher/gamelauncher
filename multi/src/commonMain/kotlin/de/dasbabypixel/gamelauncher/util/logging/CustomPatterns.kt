...
object CustomPatterns {
    ...
    val DEFAULT_PATTERN_PRINT_WITH_LOCATION = "$TIME $LOGGER $THREAD $LOCATION: $MSG$NEWLINE$EXCEPTION"
    ...
    val DEFAULT_PATTERN_PRINT_MARKER_WITH_LOCATION = "$TIME $MARKER $LOGGER $THREAD $LOCATION: $MSG$NEWLINE$EXCEPTION"
    val DEFAULT_PATTERN_PRINT_MARKER_WITHOUT_LOCATION = "$TIME $MARKER $LOGGER $THREAD: $MSG$NEWLINE$EXCEPTION"
