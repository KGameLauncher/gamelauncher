...
value class Color(val rgba: UInt) {
    ...
    fun withGB(green: UByte, blue: UByte): Color =
        Color(rgba and 0xFF0000FFu or green0(green) or blue0(blue))

    fun withRB(red: Int, blue: Int): Color = withRB(red.toUByte(), blue.toUByte())
    fun withRB(red: UByte, blue: UByte): Color =
        Color(rgba and 0x00FF00FFu or red0(red) or blue0(blue))

    fun withRG(red: Int, green: Int): Color = withRG(red.toUByte(), green.toUByte())
    fun withRG(red: UByte, green: UByte): Color =
        Color(rgba and 0x0000FFFFu or red0(red) or green0(green))

    fun withRGB(red: Int, green: Int, blue: Int): Color =
        withRGB(red.toUByte(), green.toUByte(), blue.toUByte())
