...
inline fun <reified T : Any> getDirectLogger(marker: String): Logger =
    getDirectLogger<T>().withDefaultMarker(marker)

inline fun <reified T : Any> T.getDirectLogger() = getDirectLogger(T::class)
inline fun <reified T : Any> T.getDirectLogger(marker: String) =
    getDirectLogger(T::class).withDefaultMarker(marker)
