...
class VulkanCommandPool(
    tracker: ResourceTracker, val commandPool: VKCommandPool, val graphicsPipeline: VulkanGraphicsPipeline
    ...
    companion object {
        fun create(
            tracker: ResourceTracker, device: VulkanLogicalDevice, graphicsPipeline: VulkanGraphicsPipeline
        ): VulkanCommandPool {
